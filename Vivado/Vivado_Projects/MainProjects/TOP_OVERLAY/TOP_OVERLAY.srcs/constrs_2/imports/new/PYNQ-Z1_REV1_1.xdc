...
set_property PACKAGE_PIN Y18 [get_ports {SIG_OUT[0]}]
set_property PACKAGE_PIN Y19 [get_ports {SIG_OUT[1]}]
set_property PACKAGE_PIN Y16 [get_ports {SIG_OUT[2]}]
set_property PACKAGE_PIN Y17 [get_ports {SIG_OUT[3]}]
...
set_property PACKAGE_PIN W16 [get_ports E_TRIG]
set_property IOSTANDARD LVCMOS33 [get_ports E_TRIG]
set_property PACKAGE_PIN V16 [get_ports TRIG_T0]
